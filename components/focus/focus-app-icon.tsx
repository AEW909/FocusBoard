...
export function createFocusAppleIcon() {
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="focusAppleIconGradient" x1="58" y1="49" x2="230" y2="205" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FF4DCA" />
              <stop offset="1" stopColor="#8E5DFF" />
            </linearGradient>
          </defs>
          <path d="M56 73C56 36 88 10 126 14L154 17C196 22 226 57 226 100V150C226 191 193 224 152 224H128C88 224 56 192 56 152V73Z" fill="url(#focusAppleIconGradient)" stroke="#111111" strokeWidth="8" />
...
export function createFocusIcon192() {
  return new ImageResponse(
    (
      <div
        style={{
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="focusIcon192Gradient" x1="58" y1="49" x2="230" y2="205" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FF4DCA" />
              <stop offset="1" stopColor="#8E5DFF" />
            </linearGradient>
          </defs>
          <path d="M56 73C56 36 88 10 126 14L154 17C196 22 226 57 226 100V150C226 191 193 224 152 224H128C88 224 56 192 56 152V73Z" fill="url(#focusIcon192Gradient)" stroke="#111111" strokeWidth="8" />
          <circle cx="107" cy="106" r="18" fill="#FFF7FF" stroke="#111111" strokeWidth="8" />
          <circle cx="176" cy="106" r="18" fill="#FFF7FF" stroke="#111111" strokeWidth="8" />
          <circle cx="107" cy="106" r="7" fill="#111111" />
          <circle cx="176" cy="106" r="7" fill="#111111" />
...
export function createFocusIcon() {
  return new ImageResponse(
    (
      <div
        style={{
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="focusIconGradient" x1="58" y1="49" x2="230" y2="205" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FF4DCA" />
              <stop offset="1" stopColor="#8E5DFF" />
            </linearGradient>
          </defs>
          <path d="M56 73C56 36 88 10 126 14L154 17C196 22 226 57 226 100V150C226 191 193 224 152 224H128C88 224 56 192 56 152V73Z" fill="url(#focusIconGradient)" stroke="#111111" strokeWidth="8" />
          <circle cx="107" cy="106" r="18" fill="#FFF7FF" stroke="#111111" strokeWidth="8" />
          <circle cx="176" cy="106" r="18" fill="#FFF7FF" stroke="#111111" strokeWidth="8" />
          <circle cx="107" cy="106" r="7" fill="#111111" />
          <circle cx="176" cy="106" r="7" fill="#111111" />
